...
<head>
    ...
    <title>@yield('title', 'Creme&Crumb')</title>
...
<body>
    ...
    <img src="{{ asset('images/logo.jpg') }}" alt="CremenCrumb" height="40" class="d-inline-block align-text-top me-2" style="height: 40px; width: auto;">
    Creme&Crumb
</a>
